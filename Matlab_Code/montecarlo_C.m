function [I,V,e,B1,B2] = montecarlo_C(n)
...
for i=1:n
    ...
    y=max(exp(x)-1, 0); % On simule une v.a de loi Y_1 (correspond a Y_i)
    S1=S1+y; S2=S2+y^2;
    I=S1/i;
    Ivect=[Ivect I];
...
title("Valeur approchee de C en fonction du nombre de simulations par la methode de Monte Carlo");
