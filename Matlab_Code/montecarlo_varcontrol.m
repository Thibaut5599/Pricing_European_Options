function [I,V,e,B1,B2] = montecarlo_varcontrol(n)
...
for i=1:n
    ...
    y=exp(1/2)-1+max(1-exp(x), 0); % On simule une v.a de loi Y_1 (correspond a Y_i)
    S1=S1+y; S2=S2+y^2;
    I=S1/i;
    Ivect=[Ivect I];
...
title("Valeur approchee de C en fonction du nombre de simulations par la methode de Monte Carlo avec variables de controle");
